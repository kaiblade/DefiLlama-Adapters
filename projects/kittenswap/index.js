...
const exportStandardPoolTVL = uniV3Export({
  ...
  hyperliquid: { factory: '0x5f95E92c338e6453111Fc55ee66D4AafccE661A7', fromBlock: 11022081, isAlgebra: true , extraKey:'standard-pool'}, // For standard pools
})
...
const exportCustomPoolTVL = uniV3Export({
  ...
  hyperliquid: { factory: '0x5f95E92c338e6453111Fc55ee66D4AafccE661A7', fromBlock: 11022081, isAlgebra: true , isCustom: true, extraKey:'custom-pool'} // For custom pools
})
